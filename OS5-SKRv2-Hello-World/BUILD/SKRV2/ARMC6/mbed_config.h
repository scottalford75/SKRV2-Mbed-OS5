...
#define CLOCK_SOURCE                                                          USE_PLL_HSE_XTAL|USE_PLL_HSI                                                                     // set by target:SKRV2
...
#define MBED_CONF_TARGET_LSE_AVAILABLE                                        0                                                                                                // set by target:SKRV2
#define MBED_CONF_TARGET_MPU_ROM_END                                          0x0fffffff                                                                                       // set by target:Target
#define MBED_CONF_TARGET_STDIO_UART_RX                                        PA_10                                                                                            // set by application[*]
#define MBED_CONF_TARGET_STDIO_UART_TX                                        PA_9                                                                                             // set by application[*]
